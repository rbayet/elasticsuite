...
class ConfigTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function stringFieldDynamicConfigProvider()
    {
        return [
            ...
            [['type' => FieldInterface::FIELD_TYPE_KEYWORD, 'fieldConfig' => ['default_search_analyzer' => FieldInterface::ANALYZER_EDGE_NGRAM]]],
        ];
    }
    ...
    protected function getDataSourceResolverFactoryMock($stringFieldDynamicConfig)
    {
        ...
        $dataSourceResolverFactory->method('create')->willReturnCallback(
            function ($args) use ($stringFieldDynamicConfig) {
    ...
    {
        $stringFieldConfig = ['name' => 'stringField'] + $stringFieldDynamicConfig;
